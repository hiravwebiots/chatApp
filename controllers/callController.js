...
const initiateCall = async (req, res) => {
    try {
        ...
        const populatedCall = await callModel
            .findById(call.id)
            .populate('initiatorId', 'name profilePhoto')
        ...
        io.to(receiverId).emit('call-incoming', {
            ...
            callerAvatar: initiator.profilePhoto || null,
            callType: callType
        })
        ...
        res.status(200).json({ status: 1, message: 'Successfully initiate Call', data: populatedCall })
